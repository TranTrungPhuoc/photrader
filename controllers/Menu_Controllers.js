...
class Menu_Controllers extends Controllers{
    ...
    async formList(data){
        return [
            { title: 'Tên Menu', type: 'text', col: 4, class: 'title form-control ', id: 'title', value: (data.length==0)?'':data[0]['title'], placeholder: 'Nhập Menu', require: false, disabled: false, check: true, event: '' },
